  ...
  const systems = [
    {
      ...
      technologies: ['React 19', 'Node.js', 'MongoDB', 'Stripe', 'JWT', 'Passport.js', 'Cloudinary', 'Socket.IO'],
      features: [
    ...
    },
    {
      ...
      technologies: ['React 19', 'Node.js', 'MongoDB', 'Express.js', 'Socket.IO', 'JWT', 'Cloudinary'],
      features: [
        'Secure JWT-based login with role-based access',
        'User management for students, teachers, and administrators',
        'Complete academic structure with programs, subjects, and classes',
        'Digital attendance tracking with reports',
        'Assignment creation, submission, and grading',
        'Digital marksheets with GPA calculation',
        'Fee and salary management with payment tracking',
